            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <article class="presentationgen">
                        ...
                        , l'entreprise qui m'a accueilli lors de ces deux années d'alternances ainsi que mon projet professionnel.
                        <br>
                        ...
                        durant mon BTS, mais également d'autres ressources utiles (CV, Veilles, Tableau de compétences etc...)
                        Bonne visite !
                    </article>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <article class="presentationent">
                        ...
                        (Sous-Direction des Services Opérationnels). Le STI compte environ 100 personnes.
                        L'équipe que j'ai intégré se nomme ETD (Etude Technique et Développement), elle est composée de 5 développeurs. 
                        Elle a pour activité de développer et de maintenir des application web internes a la Police. Parfois a l'échelle nationale 
